...
turtles-own [earnings guess correct?]
to setup
  ca
  reset-ticks
  crt nr-agents  
...
to go
  ...
  ask turtles [
    ifelse guess = stockmarket [set correct? 1][set correct? 0]
  ]
  let poolshare 0
...
false
false
"set-plot-x-range -50 50\nset-plot-y-range 0 500\nset-histogram-num-bars 101" ""
PENS
"default" 1.0 1 -16777216 true "" "histogram [earnings] of turtles"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if ticks > 0 [plot max [earnings] of turtles]"
