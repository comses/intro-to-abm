...
to update-gini
  ...
  if total-wealth = 0 [set gini 0]
  if min-wealth < 0 [
    set total-wealth total-wealth - people * min-wealth
    set index 0
    repeat people [
      set sorted-wealths replace-item index sorted-wealths (item index sorted-wealths - min-wealth)
      set index index + 1
    ]
  ]
  set index 0
...
<experiments>
  <experiment name="experiment" repetitions="100" runMetricsEveryStep="false">
    ...
    <enumeratedValueSet variable="Reserves">
      <value value="10"/>
      <value value="20"/>
      <value value="30"/>
      <value value="40"/>
